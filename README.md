...
4. Сделать слушатель "telemetry" для пользователя (пространство имен пользователя /vehicles), куда он будет отсылать { id: 1 } для получения телеметри техники по id
